...
import { positionsRoutes } from '../positions/router'
...
const routes = [...homeRoutes, ...gettingStartedRoutes, ...analysisRoutes, ...positionsRoutes, ...designSystemRoutes, ...settingsRoutes, ...profileRoutes, ...faqRoutes]
