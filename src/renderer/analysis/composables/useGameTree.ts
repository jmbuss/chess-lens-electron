import { computed, MaybeRef, shallowRef, toValue, watch, markRaw } from 'vue'
import { parseGameTree, getMoveList, getLegalMoves, isInCheck, getTurn, addMove } from './GameTree'
...
export const useGameTree = ({ gameId }: { gameId: MaybeRef<string> }) => {
  ...
  // Reset currentNode when root changes (new game loaded)
  watch(
    root,
    newRoot => {
